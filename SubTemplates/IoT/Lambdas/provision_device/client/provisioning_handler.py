...
class ProvisioningHandler:
    ...
    def register_thing(self, serial, token):
        ...
        register_template = {"certificateOwnershipToken": token, "parameters": {
            "SerialNumber": self.serial_num, "ModelType": self.model_type, "hasValidAccount": self.hasValidAccount}}
    ...
    def new_cert_pub_sub(self):
        ...
        self.test_MQTTClient.subscribe(
            "dt/{}/test".format(self.serial_num), 1, self.basic_callback)
        self.test_MQTTClient.publish("dt/{}/test".format(self.serial_num), str(
